...
```{r}
Edistances <- rexp(10000)+2
Sdistances <- rexp(10000)+7
```
``` {r}
hist(Edistances)
```
...
plot(N, Emeanerror, type='l', xlab="sample size (number of people surveyed)", ylab="mean error (miles)", main="Mean error of estimates of distance commuted", ylim=c(0,0.28))
